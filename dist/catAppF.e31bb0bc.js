...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var API_KEY = "live_mKIEpaqCSlPbkK3VO3bZSMa3D91BuQZ7AvMQ7NMAi1Wx5RsrZjamUiLiqgvSayKA";
    ...
    _initialLoad = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetchData("".concat(BASE_URL, "/breeds"));
          case 2:
  ...
  function _loadCarousel() {
    _loadCarousel = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var val, url, data;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            val = breedSelect.value;
            url = "".concat(BASE_URL, "/images/search?limit=25&breed_ids=").concat(val);
            _context3.next = 4;
  ...
  function buildCarousel(data, favourites) {
    ...
    data.forEach(function (ele) {
      var item = Carousel.createCarouselItem(ele.url, breedSelect.value, ele.id);
      Carousel.appendCarousel(item);
    });
    if (favourites) {
      infoDump.innerHTML = "Here are your saved favourites!";
    } else if (data[0]) {
      var info = data[0].breeds || null;
  ...
  function toggleFavoriteImage(_x2) {
    return _toggleFavoriteImage.apply(this, arguments);
  }
  function _toggleFavoriteImage() {
    _toggleFavoriteImage = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(imageId) {
      var favorites, favorite;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return fetchData("".concat(BASE_URL, "/favourites?image_id=").concat(imageId));
          case 2:
            ...
            _context4.next = 7;
            return fetchData("".concat(BASE_URL, "/favourites/").concat(favorite.id), {
              method: 'DELETE'
            });
          case 7:
            _context4.next = 11;
          ...
          case 9:
            _context4.next = 11;
            return fetchData("".concat(BASE_URL, "/favourites"), {
              method: 'POST',
              headers: {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            imageUrls = favourites.map(function (favourite) {
              return favourite.image;
            });
...
//# sourceMappingURL=/catAppF.e31bb0bc.js.map